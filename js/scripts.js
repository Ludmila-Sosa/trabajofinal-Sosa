			...
			<article class="detalle-grid">
				...
				<div class="detalles-content">
					...
					<div class="rating">
						...
						<p class="description">
							<b>Descripcion: </b> <span>Si el tiempo lo cambia todo, este minuto lo cambia como ningún otro. Cuando llega la medianoche, el Oyster Perpetual Day‑Date crea un puente entre el pasado y el futuro, entre lo que se ha conseguido y lo que queda por vivir. Desde 1956 da testimonio de los grandes momentos de la historia en la muñeca de visionarios, virtuosos y pioneros. Aquellos que hacen de cada día una promesa para el futuro.</span>
						</p>
						<p class="description">
							<span>Reconocible inmediatamente, su diseño único ha forjado su identidad. En su lanzamiento, el Day‑Date fue el único reloj con una ventana semicircular a las 12 horas que mostraba el día de la semana con todas las letras. Con su emblemático brazalete President, únicamente disponible en metal precioso —oro o platino—, es el reloj de prestigio por excelencia.</span>
						</p>
